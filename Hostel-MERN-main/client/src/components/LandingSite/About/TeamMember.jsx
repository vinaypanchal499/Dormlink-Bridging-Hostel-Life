...
TeamCard.propTypes = {
  member: PropTypes.shape({
    ...
    links: PropTypes.arrayOf(PropTypes.string).isRequired, // ✅ added links validation
  }).isRequired,
};
  ...
  return (
    <div className="rounded-lg shadow-lg p-5 bg-gray-800">
      ...
      <div className="text-center">
        ...
        {/* ✅ Make View Profile Button Work */}
        {member.links && member.links.length > 0 && (
          <a
            href={member.links[0]} // open first link in array
            target="_blank" // open in new tab
            rel="noopener noreferrer"
            className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded inline-block transition"
          >
            click here
          </a>
        )}
